# the following codes were successfully run under R 4.1.0 and R 4.1.2
library(tidyverse)
library(lsa)
library(corpus)
library(readxl)
...
#only necessary if you want to use custom font for ggplot2
library(showtext)
font.add("Latex", "C:/Users/fqixi/AppData/Local/Microsoft/Windows/Fonts/lmroman12-regular.otf")
showtext_auto()
